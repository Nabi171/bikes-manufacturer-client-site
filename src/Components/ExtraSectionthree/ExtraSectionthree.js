            ...
            <div class="hero min-h-screen navbar-bg rounded-lg">
                <div class="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div>
                        ...
                        <p class="py-6 font-bold text-primary">If you want to order products ,you have to follow some steps,first you have to sign up,if you  are new user,Go to sign up and make register.Then you can choose the product what you need.After payment,Our man pick your order.Thank You</p>
